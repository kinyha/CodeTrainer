...
Полный список всех 79 задач с ID, тегами, исходниками и разборами:
...
|---|---|---:|
| `core-drills/src/main/java/trainer/` | Algorithms, Collections, Streams, Concurrency, Patterns | 54 |
...
| `docs/CATALOG.md` | Кликабельный каталог всех задач | 79 |
