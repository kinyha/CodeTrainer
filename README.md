...
Полный список всех 93 задач с ID, тегами, исходниками и разборами:
...
|---|---|---:|
| `core-drills/src/main/java/trainer/` | Algorithms, Collections, Streams, Concurrency, Patterns | 68 |
...
| `docs/CATALOG.md` | Кликабельный каталог всех задач | 93 |
